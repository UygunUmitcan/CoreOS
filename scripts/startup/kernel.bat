...
echo DirectX ve VisualCPP yukleniyor.
...
powercfg /h off
bcdedit /set {current} description "Kernel"
rd /s /q %WINDIR%\Temp\ >NUL 2>&1
start /wait %SYSTEMDRIVE%\drive\edge.exe
del /F /Q "%SYSTEMDRIVE%\drive\edge.exe"
...
del /F /Q "%SYSTEMDRIVE%\ProgramData\Microsoft\Windows\Start Menu\Programs\Startup\kernel.bat" >NUL 2>&1
